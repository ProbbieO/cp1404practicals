...
# ✅ TODO completed: list comprehension to create a list of all the full_names in lowercase format
lowercase_full_names = [name.lower() for name in full_names]
print(lowercase_full_names)

almost_numbers = ['0', '10', '21', '3', '-7', '88', '9']

# ✅ TODO completed: list comprehension to create a list of integers from the above list of strings
numbers = [int(num) for num in almost_numbers]
print(numbers)

# ✅ TODO completed: list comprehension to create a list of only the numbers greater than 9
numbers_over_9 = [num for num in numbers if num > 9]
print(numbers_over_9)

# ✅ TODO completed: use a list comprehension and the join string method
